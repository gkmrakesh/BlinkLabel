...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.description      = <<-DESC
This CocoaPod provides the ability to use a UILabel that may be started and stopped blinking. it can be used for label blink like error.
                       DESC

  s.homepage         = 'https://github.com/gkmrakesh/BlinkLabel.git'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Rakesh MEMBARAM' => 'rakesh.membaram@amadeus.com' }
  s.source           = { :git => 'https://github.com/gkmrakesh/BlinkingLabel.git', :tag => s.version.to_s }
